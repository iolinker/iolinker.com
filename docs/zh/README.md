...
- [Windows X86](https://github.com/iolinker/iolinker.com/releases/download/v1.2.4/iolinker-standalone-windows-amd64-v1.2.4.tar.gz)
- [1Raspberry PI 4B](https://github.com/iolinker/iolinker.com/releases/download/v1.2.4/iolinker-standalone-linux-armv7-v1.2.4.tar.gz)
